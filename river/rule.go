...
type Rule struct {
	...
	//
	// JSON path mapping is also supported (quote dotted keys in TOML):
	//   "ext.sku" = "sku"        // JSON column ext.sku -> ES top-level sku
	//   "ext.sku" = "data.sku"   // JSON column ext.sku -> ES nested data.sku
